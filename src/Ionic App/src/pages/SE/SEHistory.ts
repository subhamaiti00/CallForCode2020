...
@Component({
  selector: 'page-SEHistory',
  templateUrl: 'SEHistory.html'
})

export class SEHistory {
  // search condition
  public search = {
  ...
  this.storage.get('uid').then((val) => {
    this.uid=val;
    this.http.get(this.apiurl+'/S1/service.ashx?method=OrderCompletionByVol&uid='+this.uid).subscribe(data1 => {
        loader.dismiss();
        //alert(data1);
      if(data1==null || data1=="")
      {      
